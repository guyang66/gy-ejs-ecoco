  ...
  content: [
    {
      ...
      desc: ['法定年假、带薪病假、年度大团建','六险一金全拉满，加班车费全年报销','生日party，节日福利，等你来精彩']
    },
    {
      icon: b2,
      cover: a2,
      title: '关爱每一个员工成长路线全面匹配',
      desc: ['季度团建、红包群发、高温补贴','晋升机制完善，给你充足的自由空间','实习补助，住房补助，为你开通绿色通道']
    },
    {
      icon: b3,
      cover: a3,
      title: '环境优美让你每天都有好心情',
      desc: ['地铁打开让你无压力迟到','关爱家人，体检大礼包照顾每一个员工家人','健身卡放送，身体和工作一样不落下']
    }
  ]
}
export default data
