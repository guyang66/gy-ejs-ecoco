...
import bannerData from '@/data/solution/manufacture/banner';
import painData from '@/data/solution/manufacture/pain';
import advantageData from '@/data/solution/manufacture/advantage';
import frameworkData from '@/data/solution/manufacture/framework';
import applyData from '@/data/solution/manufacture/value';
import caseData from '@/data/solution/manufacture/case';
import recommendData from '@/data/solution/manufacture/recommend';
