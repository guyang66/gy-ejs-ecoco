...
import bannerData from '@/data/solution/finance/banner';
import painData from '@/data/solution/finance/pain';
import advantageData from '@/data/solution/finance/advantage';
import frameworkData from '@/data/solution/finance/framework';
import applyData from '@/data/solution/finance/value';
import caseData from '@/data/solution/finance/case';
import recommendData from '@/data/solution/finance/recommend';
