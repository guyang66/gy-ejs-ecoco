...
import bannerData from '@/data/solution/bigdata/banner';
import painData from '@/data/solution/bigdata/pain';
import advantageData from '@/data/solution/bigdata/advantage';
import frameworkData from '@/data/solution/bigdata/framework';
import applyData from '@/data/solution/bigdata/value';
import caseData from '@/data/solution/bigdata/case';
import recommendData from '@/data/solution/bigdata/recommend';
