...
import bannerData from '@/data/product/ai/digital/banner';
import advantageData from '@/data/product/ai/digital/advantage';
import coreData from '@/data/product/ai/digital/core';
import applyData from '@/data/product/ai/digital/apply';
import historyData from '@/data/product/ai/digital/history';
import caseData from '@/data/product/ai/digital/case';
