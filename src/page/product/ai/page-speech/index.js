...
import bannerData from "@/data/product/ai/speech/banner";
import advantageData from "@/data/product/ai/speech/advantage";
import coreData from "@/data/product/ai/speech/core";
import applyData from "@/data/product/ai/speech/apply";
import historyData from "@/data/product/ai/speech/history";
import caseData from "@/data/product/ai/speech/case";
