...
import bannerData from "@/data/product/ai/algorithm/banner";
import advantageData from "@/data/product/ai/algorithm/advantage";
import coreData from "@/data/product/ai/algorithm/core";
import applyData from "@/data/product/ai/algorithm/apply";
import historyData from "@/data/product/ai/algorithm/history";
import caseData from "@/data/product/ai/algorithm/case";
