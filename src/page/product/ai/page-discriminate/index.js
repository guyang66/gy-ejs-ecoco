...
import bannerData from '@/data/product/ai/discriminate/banner';
import advantageData from '@/data/product/ai/discriminate/advantage';
import coreData from '@/data/product/ai/discriminate/core';
import applyData from '@/data/product/ai/discriminate/apply';
import historyData from '@/data/product/ai/discriminate/history';
import caseData from '@/data/product/ai/discriminate/case';
