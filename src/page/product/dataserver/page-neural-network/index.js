...
import bannerData from "@/data/product/dataserver/neural-network/banner";
import advantageData from "@/data/product/dataserver/neural-network/advantage";
import coreData from "@/data/product/dataserver/neural-network/core";
import applyData from "@/data/product/dataserver/neural-network/apply";
import historyData from "@/data/product/dataserver/neural-network/history";
import caseData from "@/data/product/dataserver/neural-network/case";
