...
import bannerData from '@/data/product/fruits/persimmon/banner';
import advantageData from '@/data/product/fruits/persimmon/advantage';
import coreData from '@/data/product/fruits/persimmon/core';
import applyData from '@/data/product/fruits/persimmon/apply';
import historyData from '@/data/product/fruits/persimmon/history';
import caseData from '@/data/product/fruits/persimmon/case';
