...
import coreData from '@/data/product/fruits/plum/core';
import applyData from '@/data/product/fruits/plum/apply';
import historyData from '@/data/product/fruits/plum/history';
import caseData from '@/data/product/fruits/plum/case';
