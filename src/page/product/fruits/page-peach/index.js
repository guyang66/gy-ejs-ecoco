...
import bannerData from '@/data/product/fruits/peach/banner';
import advantageData from '@/data/product/fruits/peach/advantage';
import coreData from '@/data/product/fruits/peach/core';
import applyData from '@/data/product/fruits/peach/apply';
import historyData from '@/data/product/fruits/peach/history';
import caseData from '@/data/product/fruits/peach/case';
