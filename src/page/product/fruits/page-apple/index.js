...
import coreData from '@/data/product/fruits/apple/core';
import applyData from '@/data/product/fruits/apple/apply';
import historyData from '@/data/product/fruits/apple/history';
import caseData from '@/data/product/fruits/apple/case';
