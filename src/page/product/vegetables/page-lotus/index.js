...
import bannerData from "@/data/product/vegetables/lotus/banner";
import advantageData from "@/data/product/vegetables/lotus/advantage";
import coreData from "@/data/product/vegetables/lotus/core";
import applyData from "@/data/product/vegetables/lotus/apply";
import historyData from "@/data/product/vegetables/lotus/history";
import caseData from "@/data/product/vegetables/lotus/case";
