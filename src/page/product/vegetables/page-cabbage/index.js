...
import bannerData from '@/data/product/vegetables/cabbage/banner';
import advantageData from '@/data/product/vegetables/cabbage/advantage';
import coreData from '@/data/product/vegetables/cabbage/core';
import applyData from '@/data/product/vegetables/cabbage/apply';
import historyData from '@/data/product/vegetables/cabbage/history';
import caseData from '@/data/product/vegetables/cabbage/case';
